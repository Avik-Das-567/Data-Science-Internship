...
def home():
    ...
    if user_name:
        ...
        return render_template('index.html', title="Welcome", error="No name detected.")
...
def reverse():
    ...
    if user_name:
        ...
        return render_template('index.html', title="Reverse Machine", error="No name detected.")
...
def spy_name():
    ...
    if user_name:
        ...
        return render_template('index.html', title="Spy Generator", error="No name detected.")
...
def hacker():
    ...
    if user_name:
        ...
        for char in user_name:
            # Get the replacement or keep original char if not found
        ...
        return render_template('index.html', title="Hacker Terminal", error="No name detected.")
...
def vapor():
    ...
    if user_name:
        # Join characters with double spaces for that aesthetic look
        ...
        return render_template('index.html', title="Aesthetics", error="No name detected.")
...
def math_sum():
    ...
    if user_name:
        # Calculate sum of ASCII values of the characters
        total_value = sum(ord(char) for char in user_name)
        return render_template('index.html', 
                               title="Name Calculator", 
                               function_name="MODE: MATH", 
                               output=f"VALUE: {total_value}",
                               extra_info=f"Calculating the sum of ASCII values of all the characters in '{user_name}'.")
    else:
        return render_template('index.html', title="Name Calculator", error="No name detected.")
